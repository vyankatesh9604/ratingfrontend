                    ...
                    <div className="col-md-6 col-10 mx-auto">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput2"  value={training} onChange={(e)=>setTraining(e.target.value)} placeholder="Enter Training rating out of 10" required=' '/>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput3" value={environment} onChange={(e)=>setEnvironment(e.target.value)} placeholder="Enter Good Environment rating out of 10" required=' '/>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput4" className="form-lebel font-weight-bold ">EPF BENEFIT-</label>
                                <label className="p-2"><input type="radio" name="optradio" checked value={epf} onChange={(e)=>setEpf(e.target.value)} />YES</label>
                                <label  className="p-2"><input type="radio" name="optradio" checked value={epf} onChange={(e)=>setEpf(e.target.value)}/>NO</label>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput5"  value={health} onChange={(e)=>setHealth(e.target.value)} placeholder="Enter rating for Health Consiousness out of 10" required=' '/>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput6"  value={teamsprit} onChange={(e)=>setTeamsprit(e.target.value)} placeholder="Enter rating for  team sprit out of 10" required=' '/>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput6" value={policies} onChange={(e)=>setPolicies(e.target.value)} placeholder="Enter rating for protection policies out of 10" required=' '/>
                            </div>
